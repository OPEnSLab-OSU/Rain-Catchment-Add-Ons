...
title('Trial 1 beaker/validator vs validator water');
xlabel('Validator Water Mass');
ylabel('beaker mass / validator mass');
subplot(2,1,2);
plot(val2d,val2_beaker,'r');
title('Trial 2 beaker/validator vs validator water');
xlabel('Validator Water Mass');
ylabel('beaker mass / validator mass');
